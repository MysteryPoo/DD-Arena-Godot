...
func _ready():
	...
	# Connect signals
	if get_tree().connect("connected_to_server", self, "_on_client_connected_ok") != OK:
		print("Unable to connect signal (connected_to_server) !")
		
	if get_tree().connect("connection_failed", self, "_on_client_connected_fail") != OK:
...
func  _on_server_disconnected():
	print("Callback: _on_server_disconnected")
...
func _on_client_connected_fail():
	print("Callback: _on_client_connected_fail")
